        ...
        <div className="detail_container">
            ...
            <div className="detail_content">
                ...
                <div className="trip_main">
                    ...
                    <div className="top">
                        ...
                        <div className="image_second">
                            <img src="image/image_second_1.jpg" alt="">
                                <img src="image/image_second_2.jpg" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div className="top_infor">
                    <div className="review">
                        <img src="image/image_review.jpg" alt="">
                    </div>
                ...
                <div className="mid_details">
                    <div className="details_left">
                        <div className="infor_travel">
                            ...
                            <p className="intro">The beautiful country of Thailand is considered as a tourist paradise, the "land of friendly smiles" in Southeast Asia. Located in a quite favorable geographical position in the region, with borders in contact with many countries, ethnic groups, Thai culture has developed very early, inherited and mixed, influenced many unique features of neighboring peoples to create a Thailand with its own cultural identities, is a symbol of a country of agriculture and Buddhism. Visit Thailand with Airtrav today!</p>

                            <h2>Interesting experiences in the program</h2>
                            <p>
                                <span>- South Gate of Ayutthaya Temple:</span>
                                Thai Smile airline flight hours super nice - full 5 days 4 nights and 30kg checked baggage.
                            </p>
                            <p>
                                <span>- Angkor Wat Temple:</span>
                                a 12th-century temple, a World Heritage Site famous for its magnificent architecture, the most visited in Cambodia.
                            </p>
                            <p>
                                <span>- Ta Prohm - </span>
                                an ancient Khmer ruin with bizarre-shaped trees was chosen by Hollywood as the filming set for the movie "The Secret of the Ancient Tomb", and some other temples in the area...
                            </p>

                            <h2>Are you ready?</h2>
                            <p>
                                - Vaccine Certificate (Vaccine certificate) English version: Confirmation of at least 2 vaccine shots with QR code / or confirmation of F0 recovery from the disease (English). The information on the certificate must match the information on the passport.
                            </p>
                            <p>
                                - Children over 12 years old are required to have a certificate of vaccination with 2 doses
                            </p>

                            <p>
                                - In case children under 12 years old are not old enough to receive injections accompanied by parents who have injected without testing.
                            </p>
                        ...
                        <div className="highlight">
                            ...
                            <div className="day_details">
                                <ul>
                                    ...
                                    <li>Seawalker activity (at own expense): Walking on the ocean floor in an air-pumped suit </li>
                            ...
                            <img src="" alt="">
                                ...
                                <p className="expr">This full-day private tour from Bangkok takes you to the UNESCO Heritage Site of Ayutthaya, one of Indo-China's most prosperous cities during the ancient times. See traces of its glorious past on the red brick ruins in and around the city island surrounded by the rivers of Chao Phraya, Pa Sak, and Lop Buri. Visit the Bang Pa-in Palace, the summer retreat of the royal court in the 17th century. You will also stop by four important temples of exquisite designs before heading back to Bangkok.</p>
                        </div>
                        <div className="notes">
                            ...
                            <div className="mess_add">
                                ...
                                <textarea name="" id="" cols="30" rows="10" placeholder="Please enter your messages"></textarea>
                            </div>
                        </div>
                    </div>
            ...
            <div id="modal" className="modal">
                <div className="modal-content">
                    ...
                    <div><h2 style="font-size: 2em;" className="payment">Payment</h2></div>
                            ...
                            <div className="infor-cus">
                                ...
                                <div className="detail-method">
                                    ...
                                    <div className="visa-method" id="visa-me">
                                        <div className="cr">
                                            <label for="cr">Credit Card Number: </label>
                                            <input type="cr" id="cr" name="cr" required>
                                        </div>
                                        <div className="cr-name">
                                            <label for="cr-name">Credit Card Name: </label>
