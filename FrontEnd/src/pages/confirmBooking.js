  ...
  const handleConfirmBooking = async () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        let errorMessage = response.data.message || "Error creating booking";
        if (response.message === "Not enough available seats") {
          errorMessage = "Sorry, this tour is fully booked. Please choose another tour.";
        }
        setNotification({
          open: true,
      ...
      // Xử lý lỗi bất ngờ hoặc lỗi từ server
    ...
    <>
      ...
      >
        <Alert
          ...
          sx={{
            bgcolor:
              notification.severity === "success" ? "#e0f Wikif7fa" : "#ffebee",
      ...
      >
        ...
        >
          <Typography
            variant="h5"
            sx={{ mb: 2, fontWeight: "bold", color: "#1a3c34" }}
          >
            Tour Information
          </Typography>
          <Typography
              ...
              paymentMethods.map((method) => (
                <Button
                  ...
                  sx={{
                    ...
                    borderColor:
                      selectBtnPayment === method.id ? "#1a73e8" : "#e0e0e0",
                    backgroundColor:
                      selectBtnPayment === method.id ? "#e3f2fd" : "white",
