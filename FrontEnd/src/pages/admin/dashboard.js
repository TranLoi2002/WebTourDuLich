            ...
            <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
              ...
              <li>
                ...
                <li>
                  <button
                    type="button"
                    className={`flex items-center w-full p-2 rounded-lg group ${activeTab === 'booking' ? 'bg-gray-200 dark:bg-gray-700' : 'text-gray-300 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700'}`}
                ...
                <li>
                  <button
                    type="button"
                    className={`flex items-center w-full p-2 rounded-lg group ${activeTab === 'tour' ? 'bg-gray-200 dark:bg-gray-700' : 'text-gray-300 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700'}`}
                ...
                <li>
                  <button
                    type="button"
                    className={`flex items-center w-full p-2 rounded-lg group ${activeTab === 'user' ? 'bg-gray-200 dark:bg-gray-700' : 'text-gray-300 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700'}`}
