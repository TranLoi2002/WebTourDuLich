                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-600">Place of
                                                Departure*</label>
                                            <input
                                                type="text"
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-600">Tour
                                                Type*</label>
                                            <select
                                                name="tourTypeId"
                                ...
                                <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-600">Discount
                                                (%)</label>
                                            <input
                                                type="number"
                                                name="discount"
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-600">Max
                                                Participants*</label>
                                            <input
                                                type="number"
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-600">Start
                                                Date*</label>
                                            <input
                                                type="date"
                                                name="startDate"
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-600">Activity
                                                Tour</label>
                          ...
                          {tourForm.active ? 'Active' : 'Inactive'}
                                ...
                                <div className="md:col-span-2 bg-gray-50 p-6 rounded-lg shadow-sm">
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            <label
                                                className="block text-sm font-medium text-gray-600">Thumbnail*</label>
                                            <input
                                                type="file"
                                                name="thumbnail"
                                ...
                                <div className="md:col-span-2 bg-gray-50 p-6 rounded-lg shadow-sm">
                                    <h3 className="text-lg font-semibold text-gray-800 mb-4">Description &
                                        Highlights</h3>
                                    <div className="space-y-4">
                                        <div>
                                            <label
                                            ...
                                            <div className="mt-1 border border-gray-300 rounded-md shadow-sm">
                                                <CKEditor
                                                    ...
                                                    data={tourForm.description || selectedTour.description} // Hiển thị nội dung mô tả
                                        ...
                                        <div>
                                            <label
                                                className="block text-sm font-medium text-gray-600">Highlights</label>
                                            <div className="mt-1 border border-gray-300 rounded-md shadow-sm">
                                                <CKEditor
                                                    editor={ClassicEditor}
                                                    data={tourForm.highlights || selectedTour.highlights} // Hiển thị nội dung mô tả
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <p className="text-sm text-gray-600">
                                                <span
                                                    className="font-medium">Tour Type:</span> {selectedTour.tourType?.name || 'N/A'}
                                            </p>
                                            <p className="text-sm text-gray-600">
                                                <span
                                                    className="font-medium">Location:</span> {selectedTour.location?.name || 'N/A'}
                                            </p>
                                        </div>
                                    </div>
                                    <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
                                        <h3 className="text-lg font-semibold text-gray-800 mb-4">Pricing &
                                            Availability</h3>
                                        <div className="space-y-3">
                                            <p className="text-sm text-gray-600">
                          ...
                          {selectedTour.active ? 'Yes' : 'No'}
                                ...
                                {selectedTour.description && (
                                    <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
                                        ...
                                        <p className="text-sm text-gray-600"
                                                dangerouslySetInnerHTML={{__html: selectedTour.description}}></p>
                                ...
                                {selectedTour.highlights && (
                                    <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
                                        ...
                                        <p className="text-sm text-gray-600"
                                           dangerouslySetInnerHTML={{__html: selectedTour.highlights}}></p>
                                    </div>
                                )}
                            </div>
                        )}
