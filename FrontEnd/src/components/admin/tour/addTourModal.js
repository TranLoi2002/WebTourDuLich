        ...
        <div className="p-8">
                ...
                <div>
                  ...
                  <div className="mt-1 flexed items-center">
                    ...
                    <label
                      ...
                      className={`relative inline-flex items-center h-6 rounded-full w-11 cursor-pointer transition-colors duration-200 ease-in-out ${tourForm.activityTour ? 'bg-indigo-600' : 'bg-gray-200'
                        }`}
                    >
                      <span
                        className={`absolute left-0 inline-block w-5 h-5 transform bg-white rounded-full shadow transition-transform duration-200 ease-in-out ${tourForm.activityTour ? 'translate-x-5' : 'translate-x-0'
                          }`}
                      />
                    </label>
                ...
                <div>
                  ...
                  <div className="mt-1 flex items-center">
                    ...
                    <label
                      ...
                      className={`relative inline-flex items-center h-6 rounded-full w-11 cursor-pointer transition-colors duration-200 ease-in-out ${tourForm.active ? 'bg-indigo-600' : 'bg-gray-200'
                        }`}
                    >
                      <span
                        className={`absolute left-0 inline-block w-5 h-5 transform bg-white rounded-full shadow transition-transform duration-200 ease-in-out ${tourForm.active ? 'translate-x-5' : 'translate-x-0'
                          }`}
                      />
                    </label>
                    <span className="ml-3 text-sm text-gray-600">
          ...
          <div className="mt-6 flex justify-end space-x-3">
            ...
            <button
              ...
              className={`inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white ${isAdding ||
                  !tourForm.title ||
                  !tourForm.placeOfDeparture ||
                  !tourForm.price ||
                  !tourForm.maxParticipants ||
