...
function TypeTable() {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      setFilteredTypes(filteredTypes.filter((item) => item.id !== id));
  ...
  return (
    <div className="p-4">
      ...
      <div className="flex items-center mb-4 gap-4">
        ...
        <button
          onClick={() => toast.info('Add New Type feature not implemented yet.')}
              ...
              filteredTypes.map((type, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    <p className='ml-2 px-2 inline-flex text-xs leading-5 font-semibold bg-blue-100 text-blue-800'>{type.active ? 'Yes' : 'No'}</p>
                    </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    <button
                      onClick={(e) => {
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-900 ">{selectedType.active ? 'Yes' : 'No'}</p>
              </div>
            </div>
