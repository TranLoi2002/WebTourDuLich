...
function PaymentMethodTable() {
  ...
  const fetchMethods = async () => {
    ...
    try {
      ...
      const res = await axios.get('http://localhost:8080/api/payment/payment-methods', { params });
  ...
  const toggleActiveStatus = async (id, currentActive, name) => {
    ...
    try {
      ...
      await axios.put(`http://localhost:8080/api/payment/payment-methods/${id}`, {
        name,
  ...
  const submitEdit = async () => {
    ...
    try {
      ...
      await axios.put(`http://localhost:8080/api/payment/payment-methods/${editModal.method.id}`, {
        name: formData.name,
  ...
  const submitAdd = async () => {
    ...
    try {
      ...
      const res = await axios.post('http://localhost:8080/api/payment/payment-methods', {
        name: formData.name,
        active: formData.active,
      });
